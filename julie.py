...
welcome_response = ["hi", "hey", "Heeeyy", "hi there", "hello", "I am glad! You are talking to me"]
...
def generateResponse(user_response):
    ...
    if(req_tfidf==0) or "tell me about" in user_response:
        print("Finding Answar....")
        if user_response:
            robo_response = wikipedia_data(user_response)
            return robo_response
    else:
        robo_response = robo_response+sent_tokens[idx]
        return robo_response#wiki
...
flag=True
print("My name is Julie and I'm a chatbot. If you want to exit, type Bye!")
while(flag==True):
    user_response = input()
    ...
    if(user_response not in ['bye','shutdown','exit', 'quit']):
        if(user_response=='thanks' or user_response=='thank you' ):
            ...
            if(welcome(user_response)!=None):
                print("Julie : "+welcome(user_response))
            else:
                print("Julie : ",end="")
